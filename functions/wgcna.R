#' WGCNA function
#'
#' This function allows you to do WGCNA for transcriptomics data and metabolomics data. 
#' Dependent packages includes "WGCNA" and "flashClust". 
#' Calculations takes long time for large feature amount.  
#' @param  input.ds  input data in txt format, where rows are features and columns are different samples.  
#' @param  min.ModuleSize  
#' @param  cut.Height 
#' @param  outputDir  output directory
#' @param  output.prefix   output prefix
#'  
#' @examples
#' wgcna("input/path/file", min.ModuleSize=10, cut.Height = 0.1, outputDir = "wgcna/output/directory",output.prefix="hostT")
