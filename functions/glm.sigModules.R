...
#' @param  meta.file   meta data prepared in txt file, must contain a column named SampleID and one column named Y. aim to find significant association between omics modules and Y. 
#' @param  glm.family   "Guassian" for continuous and unbounded Y; "binomial" for binary Y (0/1 or proportions of "successes" and "failures"); "Gamma" or "inverse.gaussian" for continuous non-negative  Y;  "poisson" for when Y is counts and when mean is equal to variance;  "quasipoisson" for when Y is counts
