#' ko2cmpd function 
#'
#' This function generates information on substrates, products and substrate&products (in the format of metacyc compound names) for each KO number. 
...
#' 
#' @param  dbDir  database directory containing the "ko01000.keg" and "metacyc_reactions.txt" files
#' 
#'  
#' @examples
#' ko2cmpd(dbDir = "path/of/database/dir" )
